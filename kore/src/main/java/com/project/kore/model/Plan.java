...
public class Plan {
    ...
    @PositiveOrZero(message = "monthlyCreditsPsico non può essere negativo")
    private int monthlyCreditsPsico;
    ...
    public int getMonthlyCreditsPsico() { return monthlyCreditsPsico; }
    public void setMonthlyCreditsPsico(int monthlyCreditsPsico) { this.monthlyCreditsPsico = monthlyCreditsPsico; }
