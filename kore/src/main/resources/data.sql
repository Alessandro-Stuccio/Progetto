...
-- Piani
INSERT INTO plans (name, duration, monthly_creditspt, monthly_credits_nutri, monthly_credits_psico, full_price, monthly_installment_price)
VALUES
    ('Basic Pack Semestrale',   'SEMESTRALE', 1, 1, 1,  960.0,  160.0),
    ('Basic Pack Annuale',      'ANNUALE',    1, 1, 1, 1800.0,  150.0),
    ('Premium Pack Semestrale', 'SEMESTRALE', 2, 2, 2, 1620.0,  270.0),
    ('Premium Pack Annuale',    'ANNUALE',    2, 2, 2, 3000.0,  250.0)
...
VALUES
    ...
    (0, 'psico1@test.com',     '$2a$10$0VtW52huEimaZO64NAgNpO8NXKTrMutT24RHz..em0HI8QkxW0.eu', 'Sara',    'Romano',        'PSYCHOLOGIST',     NULL, NULL),
    (0, 'psico2@test.com',     '$2a$10$0VtW52huEimaZO64NAgNpO8NXKTrMutT24RHz..em0HI8QkxW0.eu', 'Paolo',   'Gentile',       'PSYCHOLOGIST',     NULL, NULL),
...
-- Assegna lo psicologo a ogni cliente: psico1 ai clienti di pt1, psico2 ai clienti di pt2.
UPDATE users SET assigned_psychologist_id = (SELECT id FROM users WHERE email = 'psico1@test.com')
WHERE role = 'CLIENT' AND assigned_pt_id = (SELECT id FROM users WHERE email = 'pt1@test.com');
UPDATE users SET assigned_psychologist_id = (SELECT id FROM users WHERE email = 'psico2@test.com')
WHERE role = 'CLIENT' AND assigned_pt_id = (SELECT id FROM users WHERE email = 'pt2@test.com');

-- ============================================================
-- Abbonamenti
-- ============================================================
INSERT INTO subscriptions (version, user_id, plan_id, payment_frequency, start_date, end_date, active, current_creditspt, current_credits_nutri, current_credits_psico, last_renewal_date, installments_paid, total_installments, next_payment_date)
VALUES (0, (SELECT id FROM users WHERE email = 'luca@test.com'), (SELECT id FROM plans WHERE name = 'Basic Pack Semestrale'),
    'UNICA_SOLUZIONE', CURRENT_DATE, CURRENT_DATE + INTERVAL '6 months', true, 1, 1, 1, CURRENT_DATE, 1, 1, NULL)
ON CONFLICT DO NOTHING;

INSERT INTO subscriptions (version, user_id, plan_id, payment_frequency, start_date, end_date, active, current_creditspt, current_credits_nutri, current_credits_psico, last_renewal_date, installments_paid, total_installments, next_payment_date)
VALUES (0, (SELECT id FROM users WHERE email = 'sofia@test.com'), (SELECT id FROM plans WHERE name = 'Basic Pack Annuale'),
    'RATE_MENSILI', CURRENT_DATE, CURRENT_DATE + INTERVAL '12 months', true, 1, 1, 1, CURRENT_DATE, 1, 12, CURRENT_DATE + INTERVAL '1 month')
ON CONFLICT DO NOTHING;

INSERT INTO subscriptions (version, user_id, plan_id, payment_frequency, start_date, end_date, active, current_creditspt, current_credits_nutri, current_credits_psico, last_renewal_date, installments_paid, total_installments, next_payment_date)
VALUES (0, (SELECT id FROM users WHERE email = 'matteo@test.com'), (SELECT id FROM plans WHERE name = 'Premium Pack Semestrale'),
    'UNICA_SOLUZIONE', CURRENT_DATE, CURRENT_DATE + INTERVAL '6 months', true, 2, 2, 2, CURRENT_DATE, 1, 1, NULL)
ON CONFLICT DO NOTHING;

INSERT INTO subscriptions (version, user_id, plan_id, payment_frequency, start_date, end_date, active, current_creditspt, current_credits_nutri, current_credits_psico, last_renewal_date, installments_paid, total_installments, next_payment_date)
VALUES (0, (SELECT id FROM users WHERE email = 'chiara@test.com'), (SELECT id FROM plans WHERE name = 'Premium Pack Annuale'),
    'RATE_MENSILI', CURRENT_DATE, CURRENT_DATE + INTERVAL '12 months', true, 2, 2, 2, CURRENT_DATE, 1, 12, CURRENT_DATE + INTERVAL '1 month')
ON CONFLICT DO NOTHING;
...
VALUES (0, (SELECT id FROM users WHERE email = 'valentina@test.com'), (SELECT id FROM plans WHERE name = 'Premium Pack Annuale'),
    'UNICA_SOLUZIONE', CURRENT_DATE, CURRENT_DATE + INTERVAL '12 months', true, 2, 2, 2, CURRENT_DATE, 1, 1, NULL)
ON CONFLICT DO NOTHING;

INSERT INTO subscriptions (version, user_id, plan_id, payment_frequency, start_date, end_date, active, current_creditspt, current_credits_nutri, current_credits_psico, last_renewal_date, installments_paid, total_installments, next_payment_date)
VALUES (0, (SELECT id FROM users WHERE email = 'francesca@test.com'), (SELECT id FROM plans WHERE name = 'Basic Pack Semestrale'),
    'RATE_MENSILI', CURRENT_DATE, CURRENT_DATE + INTERVAL '6 months', true, 1, 1, 1, CURRENT_DATE, 1, 6, CURRENT_DATE + INTERVAL '1 month')
ON CONFLICT DO NOTHING;
...
VALUES
    ...
    ((SELECT id FROM users WHERE email = 'psico1@test.com'), 'MONDAY',    '09:00:00', '13:00:00'),
    ((SELECT id FROM users WHERE email = 'psico1@test.com'), 'WEDNESDAY', '15:00:00', '19:00:00'),
    ((SELECT id FROM users WHERE email = 'psico1@test.com'), 'FRIDAY',    '09:00:00', '13:00:00'),
    ((SELECT id FROM users WHERE email = 'psico2@test.com'), 'TUESDAY',   '10:00:00', '14:00:00'),
    ((SELECT id FROM users WHERE email = 'psico2@test.com'), 'THURSDAY',  '16:00:00', '20:00:00'),
    ((SELECT id FROM users WHERE email = 'psico2@test.com'), 'SATURDAY',  '09:00:00', '12:00:00');
...
-- PSICO1 e PSICO2: slot passati (per booking completati e recensioni)
INSERT INTO slots (professional_id, start_time, end_time, booked_by_id, status, meeting_link, reminder_sent, version)
VALUES
    ((SELECT id FROM users WHERE email = 'psico1@test.com'), (CURRENT_DATE - 9 + TIME '09:00:00')::timestamp, (CURRENT_DATE - 9 + TIME '09:30:00')::timestamp,
     (SELECT id FROM users WHERE email = 'luca@test.com'),        'COMPLETED', 'https://meet.jit.si/Kore_luca_psico1_past',    true, 1),
    ((SELECT id FROM users WHERE email = 'psico1@test.com'), (CURRENT_DATE - 7 + TIME '09:00:00')::timestamp, (CURRENT_DATE - 7 + TIME '09:30:00')::timestamp,
     (SELECT id FROM users WHERE email = 'sofia@test.com'),       'COMPLETED', 'https://meet.jit.si/Kore_sofia_psico1_past',   true, 1),
    ((SELECT id FROM users WHERE email = 'psico2@test.com'), (CURRENT_DATE - 9 + TIME '10:00:00')::timestamp, (CURRENT_DATE - 9 + TIME '10:30:00')::timestamp,
     (SELECT id FROM users WHERE email = 'matteo@test.com'),      'COMPLETED', 'https://meet.jit.si/Kore_matteo_psico2_past',  true, 1),
    ((SELECT id FROM users WHERE email = 'psico2@test.com'), (CURRENT_DATE - 7 + TIME '10:00:00')::timestamp, (CURRENT_DATE - 7 + TIME '10:30:00')::timestamp,
     (SELECT id FROM users WHERE email = 'chiara@test.com'),      'COMPLETED', 'https://meet.jit.si/Kore_chiara_psico2_past',  true, 1);
...
INSERT INTO slots (professional_id, start_time, end_time, booked_by_id, status, meeting_link, reminder_sent, version)
VALUES
    ((SELECT id FROM users WHERE email = 'psico1@test.com'), (CURRENT_DATE + 4 + TIME '09:00:00')::timestamp,  (CURRENT_DATE + 4 + TIME '09:30:00')::timestamp,
     (SELECT id FROM users WHERE email = 'luca@test.com'),      'CONFIRMED', 'https://meet.jit.si/Kore_luca_psico1_01',   false, 1),
    ((SELECT id FROM users WHERE email = 'psico1@test.com'), (CURRENT_DATE + 6 + TIME '09:00:00')::timestamp,  (CURRENT_DATE + 6 + TIME '09:30:00')::timestamp,
     (SELECT id FROM users WHERE email = 'sofia@test.com'),     'CONFIRMED', 'https://meet.jit.si/Kore_sofia_psico1_01',  false, 1),
    ((SELECT id FROM users WHERE email = 'psico2@test.com'), (CURRENT_DATE + 4 + TIME '10:00:00')::timestamp,  (CURRENT_DATE + 4 + TIME '10:30:00')::timestamp,
     (SELECT id FROM users WHERE email = 'matteo@test.com'),    'CONFIRMED', 'https://meet.jit.si/Kore_matteo_psico2_01', false, 1),
    ((SELECT id FROM users WHERE email = 'psico2@test.com'), (CURRENT_DATE + 6 + TIME '10:00:00')::timestamp,  (CURRENT_DATE + 6 + TIME '10:30:00')::timestamp,
     (SELECT id FROM users WHERE email = 'chiara@test.com'),    'CONFIRMED', 'https://meet.jit.si/Kore_chiara_psico2_01', false, 1)
ON CONFLICT (professional_id, start_time) DO UPDATE SET
    booked_by_id  = EXCLUDED.booked_by_id,
    status        = EXCLUDED.status,
    meeting_link  = EXCLUDED.meeting_link,
...
VALUES
    ...
    ((SELECT id FROM users WHERE email = 'luca@test.com'),        (SELECT id FROM users WHERE email = 'psico1@test.com'), 5, 'Sara mi ha aiutato tantissimo, grande ascolto.',      NOW() - INTERVAL '8 days'),
    ((SELECT id FROM users WHERE email = 'sofia@test.com'),       (SELECT id FROM users WHERE email = 'psico1@test.com'), 4, 'Percorso utile e professionale.',                     NOW() - INTERVAL '6 days'),
    ((SELECT id FROM users WHERE email = 'matteo@test.com'),      (SELECT id FROM users WHERE email = 'psico2@test.com'), 5, 'Paolo è molto preparato ed empatico.',                NOW() - INTERVAL '8 days'),
    ((SELECT id FROM users WHERE email = 'chiara@test.com'),      (SELECT id FROM users WHERE email = 'psico2@test.com'), 4, 'Sedute molto utili, consigliato.',                    NOW() - INTERVAL '6 days')
ON CONFLICT DO NOTHING;
...
VALUES
    ...
    ('percorso_luca.pdf',       'uploads/seed/percorso_luca.pdf',       'application/pdf', 'PSYCHOLOGY_PLAN', NOW() - INTERVAL '30 days',
     (SELECT id FROM users WHERE email = 'luca@test.com'),    (SELECT id FROM users WHERE email = 'psico1@test.com'),    'Percorso psicologico - valutazione iniziale Luca Ferri'),
    ...
    ('percorso_sofia.pdf',      'uploads/seed/percorso_sofia.pdf',      'application/pdf', 'PSYCHOLOGY_PLAN', NOW() - INTERVAL '28 days',
     (SELECT id FROM users WHERE email = 'sofia@test.com'),   (SELECT id FROM users WHERE email = 'psico1@test.com'),    'Percorso psicologico - gestione dello stress Sofia Conti'),
    ...
    ('percorso_matteo.pdf',     'uploads/seed/percorso_matteo.pdf',     'application/pdf', 'PSYCHOLOGY_PLAN', NOW() - INTERVAL '25 days',
     (SELECT id FROM users WHERE email = 'matteo@test.com'),  (SELECT id FROM users WHERE email = 'psico2@test.com'),    'Percorso psicologico - valutazione iniziale Matteo Galli'),
    ...
    ('percorso_chiara.pdf',     'uploads/seed/percorso_chiara.pdf',     'application/pdf', 'PSYCHOLOGY_PLAN', NOW() - INTERVAL '22 days',
     (SELECT id FROM users WHERE email = 'chiara@test.com'),  (SELECT id FROM users WHERE email = 'psico2@test.com'),    'Percorso psicologico - percorso di crescita Chiara Fontana'),
    ...
    ('percorso_elena.pdf',      'uploads/seed/percorso_elena.pdf',      'application/pdf', 'PSYCHOLOGY_PLAN', NOW() - INTERVAL '20 days',
     (SELECT id FROM users WHERE email = 'elena@test.com'),   (SELECT id FROM users WHERE email = 'psico1@test.com'),    'Percorso psicologico - valutazione iniziale Elena Marino'),
...
UPDATE subscriptions SET current_credits_psico = current_credits_psico - 1
WHERE user_id IN (
    SELECT id FROM users WHERE email IN
    ('luca@test.com','sofia@test.com','matteo@test.com','chiara@test.com')
) AND current_credits_psico > 0;
...
UPDATE subscriptions SET current_creditspt = 0, current_credits_nutri = 0, current_credits_psico = 0
